...
`HTML` `JavaScript` `Supabase` `Vercel`

### 🏗️ [KICKOUT](https://github.com/Guss-LF/kickout-showcase)
Ferramenta de gestão de reuniões de kickout de obra, com sistema de rascunhos por setor e mesclagem segura de dados para evitar conflitos entre usuários simultâneos.
`HTML` `JavaScript` `Supabase` `Vercel`
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/gustavoo-lf/)

---

<sub>Perfil em construção — atualizando conforme novos projetos ficam prontos.</sub>
